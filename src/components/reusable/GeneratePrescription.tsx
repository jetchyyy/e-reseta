...
const GeneratePrescription: React.FC = () => {
 ...
 const handleSavePrescription = async () => {
  ...
  // Validation - Only Patient Name is required now
  if (!patientInfo.name) {
  ...
  try {
    ...
    // Reload template one more time to ensure we have the latest version
    const templateRef = doc(db, 'resetaTemplates', currentUser.uid);
    const templateDoc = await getDoc(templateRef);
    ...
    const prescriptionData = {
      ...
      additionalNotes,
      prescriptionDate,
      template: latestTemplate, // Use the latest template
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-indigo-50 border-2 border-indigo-200 rounded-xl p-4 mb-6 flex items-center justify-between">
          ...
          <button
            ...
            disabled={refreshing}
            className="px-4 py-2 bg-white border-2 border-indigo-300 text-indigo-700 rounded-lg hover:bg-indigo-50 transition-all disabled:opacity-50 flex items-center gap-2"
          >
            {refreshing ? (
              <>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-all flex items-center gap-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div className="lg:col-span-1">
  <div className="bg-white rounded-2xl shadow-xl p-6 sticky top-6">
    ...
    >
      ...
      {/* Contact Info Preview - NOW INCLUDED */}
      {template && (
        <div className="mb-3 text-[9px]">
          ...
          {/* Clinic Hours Preview - NOW INCLUDED */}
      ...
      <div className="border-t border-gray-300 pt-2 mt-3 text-[9px]">
        <p className="font-semibold">{template.doctorName}</p>
